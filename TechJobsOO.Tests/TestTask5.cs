...
namespace TechJobsOO.Tests
{
    ...
    public class TestTask5
    {
        ...
        public void Test_TestToString_Starts_And_Ends_With_NewLine()
        {
            ...
            //setup
            string text = System.IO.File.ReadAllText("C:\\Users\\rahze\\source\\repos\\csharp6-assignment-2-techjobs-oo-Rahzen83\\TechJobsOO.Tests\\StartsAndEndsWithNewLine.txt").ToString();
        ...
        public void Test_TestToStringHandlesEmptyField()
        {
            ...
            string text = System.IO.File.ReadAllText("C:\\Users\\rahze\\source\\repos\\csharp6-assignment-2-techjobs-oo-Rahzen83\\TechJobsOO.Tests\\EmptyFieldTest.txt").ToString();
            var stringWriter = new StringWriter();
            Console.SetOut(stringWriter);
            var job = new RunTechJobs();
            job.RunProgram();
